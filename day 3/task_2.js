...
function calcLeastSteps() {
    let leastSteps = null;
    path1.forEach(function (i) {
        path2.forEach(function (j) {
            if (i.x === j.x && i.y === j.y) {
                const steps = i.steps + j.steps;
                leastSteps = !leastSteps || steps < leastSteps ? steps : leastSteps;
            }
        });
    });
    return leastSteps;
